# Le lastre ritoccate a mano

Il 2026-08-20 trentuno lastre sono state ritoccate in un editor d'immagini,
...
lavoro da solo. Confrontando le lastre spedite con quelle che `plates.py
build` produce oggi:
...
| lastra | pixel che il build sbaglia |
|---|---|
...
Il conto si rifa' cosi: si ricostruiscono le lastre in una cartella
